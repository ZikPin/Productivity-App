...
COLORS = {"black": {"self": "#020317", "opposite": "#CFEBFF"},
          ...
          "coral": {"self": "#FF7761", "opposite": "#FF5330"},
          "green": {"self": "#227A36", "opposite": "#46B346"},
          "red": {"self": "#F25CA2", "opposite": "#D9043D"},
          "orange": {"self": "#F27405", "opposite": "#F24405"}}
...
BUTTON_COLORS = {
    ...
    "coral": {"fg_color": COLORS["coral"]["self"],
               "hover_color": COLORS["coral"]["opposite"]},
    "coral_inverse": {"fg_color": COLORS["coral"]["opposite"],
               "hover_color": COLORS["coral"]["self"]},
    "red": {"fg_color": COLORS["red"]["self"],
               "hover_color": COLORS["red"]["opposite"]},
    "red_inverse": {"fg_color": COLORS["red"]["opposite"],
               "hover_color": COLORS["red"]["self"]},
    "green": {"fg_color": COLORS["green"]["self"],
               "hover_color": COLORS["green"]["opposite"]},
    "green_inverse": {"fg_color": COLORS["green"]["opposite"],
               "hover_color": COLORS["green"]["self"]},
